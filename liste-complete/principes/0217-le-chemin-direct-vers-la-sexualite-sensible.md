---
titre: "Les 4 étapes du chemin vers la sexualité sensible"
source: "principes"
date: ""
statut: "brouillon"
doublon: false
sujet: "L'auteur présente les 4 étapes nécessaires et suffisantes pour vivre une sexualité sensible : transmuter ses peurs, développer l'écoute de soi, communiquer de manière authentique, puis explorer les différentes énergies sexuelles. Ces étapes forment un chemin direct après 15 ans d'exploration personnelle."
motscles: [sexualité sensible, peur, écoute de soi, communication, exploration, transformation intérieure]
enrichi: true
---
Pour moi, cela a demandé 15 ans de stages, retraites, thérapies et formations pour arriver à vivre une sexualité authentique et sensible avec toutes mes partenaires. Dans ce parcours, j'ai glané des outils par ici, des principes par là. C'était une exploration un peu au hasard. Je découvrais un sujet qui me semblait intéressant. J'y allais. J'apprenais toujours quelque chose. J'évoluais à chaque fois mais pas forcément dans la direction d'une sexualité sensible.
