---
titre: "Les quatre types d'amant.e.s : aigle, moineau, coq, lapin"
source: "corpus"
date: "27 novembre 2021"
statut: "brouillon"
doublon: false
sujet: "Typologie humoristique et pédagogique des amants selon leur rapport à la sexualité sensible : l'aigle (pratique), le moineau (veut apprendre), le coq (peut évoluer), le lapin (ne volera jamais). L'erreur fréquente est de traiter un coq comme un moineau ; la solution est d'abord de le transformer en moineau."
motscles: [types d'amants, sexualité sensible, évolution, couple, accompagnement]
enrichi: true
---
