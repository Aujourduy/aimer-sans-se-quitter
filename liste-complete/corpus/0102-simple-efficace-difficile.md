---
titre: "Simple, efficace, difficile"
source: "corpus"
date: "26 novembre 2021"
statut: "brouillon"
doublon: false
sujet: "Les pratiques les plus transformatrices — jeûne, marche sur le feu, Vipassana, sexualité sensible — sont d'une grande simplicité de principe mais difficiles à réaliser seul. L'accompagnement change radicalement les chances de succès, comme le prouvent les taux de réussite collectifs."
motscles: [simplicité, transformation, accompagnement, sexualité sensible, pratique]
enrichi: true
---
...
Vipassana, c'est simple. On médite matin, midi et soir en écoutant son corps, sans bouger pendant 10 heures par jour et en gardant le silence toute la journée. Donc, ressentir, ne pas bouger et ne pas parler. Le tout pendant 9 jours. Cela m'a permis de lancer mon site d'agenda parisien du bien-être que j'avais en tête depuis 5 ans sans oser passer à l'action.
...
Pour vivre une sexualité authentique et sensible, en réalité c'est très simple aussi. Il y a un ensemble de pratiques qui permet d'y arriver. C'est très difficile de réussir à les faire seul, comme marcher sur le feu ou Vipassana. Mais c'est facile quand on est accompagné.
...
Voilà, il y a aussi des choses très simples, très efficaces à faire pour atteindre une sexualité sensible. Et si on ne les a pas encore faites, ce n'est pas parce que c'est compliqué avec des grandes théories ou des concepts compliqués. C'est seulement parce que c'est difficile à faire sans être accompagné.
