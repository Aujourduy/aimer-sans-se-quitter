---
titre: "Action ou vérité(s) — ma version sexuelle du jeu"
source: "corpus"
date: "26 novembre 2021"
statut: "brouillon"
doublon: false
sujet: "Quand l'excitation s'arrête sans raison apparente, l'auteur propose à sa partenaire un jeu : chercher ensemble la vérité coincée dans le cœur et la formuler. Chaque fois, l'expression honnête d'une émotion tue suffit à relancer le désir — sans aucun contact physique."
motscles: [communication, désir, vérité, authenticité, intimité]
enrichi: true
---
Ma version sexuelle.
...
A plusieurs reprises, mon excitation s'est arrêtée parce que ma partenaire n'avait pas formulé ce qu'elle avait sur le cœur. Ce n'était pas forcément un sujet grave ou important. Mais une sexualité sensible exige un niveau d'authenticité bien supérieur.
...
Précision : ce n'est pas un vrai jeu « Action et Vérité ». C'était juste un titre qui m'a inspiré pour ce post parce que le moment d'intimité devient un moment d'action ou de vérités.
